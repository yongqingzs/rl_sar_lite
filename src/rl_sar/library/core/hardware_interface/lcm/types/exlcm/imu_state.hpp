...
#ifndef __exlcm_imu_state_hpp__
#define __exlcm_imu_state_hpp__
...
int imu_state::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int imu_state::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int imu_state::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t imu_state::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* imu_state::getTypeName()
{
    return "imu_state";
}

int imu_state::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int imu_state::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int imu_state::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t imu_state::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x4d74b199d4ddbd90LL;
